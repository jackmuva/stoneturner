...
export type SlackSyncChannelsInputs = { teamId: string; cursor?: string };

export const syncChannels = async (_incremental: boolean = true, db: SqliteDb, inputs?: SlackSyncChannelsInputs, syncTaskId?: string) => {
  let offset = 0;
