...
export type FirecrawlParseInputs = { offset?: number };

export const parseFirecrawlStep = async (_incremental: boolean = false, db: SqliteDb, inputs?: FirecrawlParseInputs, syncTaskId?: string): Promise<void> => {
