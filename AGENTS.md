...
- All frontend-referenced vars **must** be present (empty value is fine): `BUN_PUBLIC_BACKEND_BASE_URL`, `BUN_PUBLIC_DEV_MODE`, `BUN_PUBLIC_DISCORD_CLIENT_ID`, `BUN_PUBLIC_GITHUB_CLIENT_ID`, `BUN_PUBLIC_HUBSPOT_CLIENT_ID`, `BUN_PUBLIC_LINEAR_CLIENT_ID`, `BUN_PUBLIC_NOTION_CLIENT_ID`, `BUN_PUBLIC_PLAUD_CLIENT_ID`, `BUN_PUBLIC_SLACK_CLIENT_ID`, `BUN_PUBLIC_SPOTIFY_CLIENT_ID`, `BUN_PUBLIC_TWITTER_CLIENT_ID`.
